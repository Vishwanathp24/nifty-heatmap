...
async function openVerdict(symbol) {
  ...
  $("#verdict-body").innerHTML = `<div class="skeleton">Loading…</div>`;
  try {
...
async function init() {
  ...
  $("#verdict-close").addEventListener("click", closeVerdictModal);
  $("#verdict-backdrop").addEventListener("click", closeVerdictModal);
  initVerdictTriggers();
